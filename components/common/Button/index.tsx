  ...
  "uppercase inline-flex items-center justify-center whitespace-nowrap rounded-md text-[2rem] leading-[2.4rem] tracking-[0.1rem] font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-neutral-950 dark:focus-visible:ring-neutral-300",
  {
    variants: {
      variant: {
        ...
        "playable-letter":
          "bg-blue cursor-default text-white text-[5.5rem] leading-[6.6rem] py-3 px-12 rounded-[2.5rem] w-[7rem] h-[8rem] shadow-[0_1px_0_6px_#3c74ff_inset,0_-2px_0_3px_#140e66_inset] disabled:bg-dark-blue disabled:shadow-[0_1px_0_6px_#221d74_inset]",
        "keyboard-letter":
          "bg-white text-dark-navy text-[3rem] leading-[3.6rem] hover:bg-blue hover:text-white rounded-[1.5rem] w-[4.625rem] h-[5.25rem] disabled:bg-white/25",
        category:
